...
export const HeroSection = ({ onAnimationComplete }: HeroSectionProps) => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      {/* Full-bleed background image - removed */}
          ...
          <AnimatePresence>
            {showContent && (
              <motion.div
                ...
                className="relative hidden lg:flex items-center justify-center min-h-screen"
              >
                <div className="absolute inset-0">
                  <img
                    src={heroBg}
                    ...
                    className="w-full h-full object-cover"
                  />
                  {/* Re-applied cinematic gradients for readability on text over image */}
                  <div className="absolute inset-0 bg-gradient-to-r from-black/85 via-black/70 to-black/40" />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-black/30" />
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent" />
                </div>
