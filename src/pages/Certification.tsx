 ...
 const certificationData: Record<string, { title: string; fullTitle: string; description: string }> = {
   'iso-14001': {
     ...
     <div className="min-h-screen bg-background">
       ...
       <section className="pt-32 pb-12 bg-background">
         <div className="container mx-auto px-4 lg:px-8">
           <Link to="/" className="inline-flex items-center gap-2 text-foreground-muted hover:text-primary transition-colors mb-8">
             <ArrowLeft size={18} />
             Back to Home
           </Link>
         ...
         <div className="container mx-auto px-4 lg:px-8">
           <div className="grid lg:grid-cols-2 gap-12 items-start">
             ...
             <motion.div
               ...
               viewport={{ once: true }}
               transition={{ duration: 0.6 }}
               className="aspect-[3/4] bg-card border border-border rounded-lg flex items-center justify-center"
             >
               <div className="text-center p-8">
                 <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-primary/10 flex items-center justify-center">
                   <Award className="w-10 h-10 text-primary" />
                 </div>
                 <p className="text-foreground-muted">Certificate Image</p>
               ...
               <div className="card-industrial p-6 rounded-lg">
                 ...
                 <div className="space-y-4">
                   ...
                   <div className="flex justify-between border-b border-border pb-3">
                     ...
                     <span className="text-foreground font-medium">TUV NORD</span>
                   </div>
                   <div className="flex justify-between border-b border-border pb-3">
                   ...
                   <div className="flex justify-between">
                     ...
                     <span className="text-foreground font-medium text-right max-w-[200px]">Design, Manufacture, Sales & Service</span>
                   </div>
                 </div>
               </div>
