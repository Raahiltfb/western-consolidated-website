    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-[#111111]">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-4 pt-4 md:pt-0">
                ...
                >
                   <AnimatePresence>
                    {showContent && (
                        ...
                        className="flex items-center gap-3 py-1 mb-4"
                        >
                  ...
                  <h1 className="text-5xl md:text-6xl lg:text-8xl font-bold leading-tight uppercase">
            ...
            <AnimatePresence>
              {showContent && (
                <motion.p
                  ...
                  className="text-white/70 text-lg max-w-lg leading-relaxed mt-4"
                >
                  Precision-engineered diesel generator sets delivering uncompromising performance for mission-critical industrial applications. From 3 kVA to 1010 kVA, our solutions ensure your operations never stop.
                </motion.p>
              )}
            </AnimatePresence>
            ...
            <AnimatePresence>
              {showContent && (
                ...
                >
                  <Link to="/products">
                    <Button variant="hero" size="lg" className="group bg-primary hover:bg-primary/90 text-white rounded-md px-8">
                      Explore Generator Sets
                      <ArrowRight size={18} className="ml-2 group-hover:translate-x-1 transition-transform" />
                    </Button>
                  </Link>
                  <Link to="/enquiry">
                    <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-black rounded-md px-8">
            ...
            <AnimatePresence>
              {showContent && (
                <motion.div
                  ...
                  className="flex items-center gap-8 pt-8 mt-8 border-t border-white/10"
                >
                  <div>
                    <div className="text-4xl font-bold text-white">60+</div>
                    <div className="text-white/50 text-xs uppercase tracking-wider">Years Engineering</div>
                  </div>
                  <div className="w-px h-10 bg-white/20" />
                  <div>
                    <div className="text-4xl font-bold text-white">5000+</div>
                    <div className="text-white/50 text-xs uppercase tracking-wider">Installations</div>
                  </div>
                  <div className="w-px h-10 bg-white/20" />
                  <div>
                    <div className="text-4xl font-bold text-white">24/7</div>
                    <div className="text-white/50 text-xs uppercase tracking-wider">Support</div>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
          ...
          {/* RIGHT SIDE - Moved background image here to match screenshot */}
          <AnimatePresence>
            {showContent && (
              <motion.div
              ...
              >
                <div className="relative z-10 w-full h-full flex flex-col items-center justify-center">
                  <img
                    src={heroBg}
                    alt="Generator Unit"
                    className="w-full h-auto object-contain drop-shadow-[0_20px_60px_rgba(0,0,0,0.8)] rounded-lg"
                  />
                  <p className="text-white/40 text-sm mt-4 italic font-light tracking-widest uppercase">
                    Image for reference, not actual
                  </p>
                </div>
              </motion.div>
            )}
      ...
      <AnimatePresence>
        {showContent && (
          ...
          >
            <div className="bg-white rounded-lg px-4 py-3 flex items-center gap-3 shadow-2xl">
              <div className="w-10 h-10 flex items-center justify-center">
                 <div className="bg-blue-900 text-white font-bold p-2 rounded">K</div>
              </div>
              <div className="border-l border-gray-200 pl-3">
                <div className="text-[10px] leading-tight font-bold text-gray-500 uppercase tracking-tighter">
                  AUTHORIZED GOEM
                </div>
