      ...
      <section className="pt-28 pb-4 bg-background">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex items-center gap-2 text-sm text-foreground-muted">
            ...
            <span>/</span>
            <Link to={`/products/${categoryId}`} className="hover:text-primary transition-colors capitalize">
              {categoryId?.replace(/-/g, ' ')}
            </Link>
            <span>/</span>
            <span className="text-foreground capitalize">{modelId?.replace(/-/g, ' ')}</span>
          </div>
        </div>
      </section>
            ...
            >
              <div className="aspect-square bg-card border border-border rounded-lg flex items-center justify-center sticky top-28">
                <div className="text-center p-8">
                  ...
                  <p className="text-foreground-muted">Product Image</p>
            ...
            >
              <div>
                ...
                <p className="text-foreground-muted text-lg leading-relaxed">
                  High-performance diesel generator set designed for reliable power supply 
                  in industrial applications. Built with precision engineering and 
