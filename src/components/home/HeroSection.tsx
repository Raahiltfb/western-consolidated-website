    ...
    <section className="relative min-h-screen flex items-center overflow-hidden bg-background">
          ...
          >
            <div className="flex flex-col items-center px-4 w-full">
              ...
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 0.8 }}
                className="relative text-foreground text-center w-full text-2xl md:text-3xl font-bold uppercase tracking-[0.4em] mt-8 md:mt-12"
              >
              ...
              {showContent && (
                ...
                >
                  <div>
                    ...
                    <div className="text-muted-foreground text-sm">Years Engineering</div>
                  </div>
                  <div className="w-px h-10 bg-border" />
                  <div>
                    <div className="text-4xl font-bold text-foreground">100,000+</div>
                    <div className="text-muted-foreground text-sm">Installations</div>
                  </div>
                  <div className="w-px h-10 bg-border" />
                  <div>
      ...
      <AnimatePresence>
        {showContent && (
          ...
          >
            <div className="bg-background/80 backdrop-blur-md border border-border rounded-lg px-4 py-3 flex items-center gap-3 shadow-lg">
